...
/// This is the primary booking model used throughout the application
/// Uses studio IDs instead of boolean flags for studio selection
class Booking {
  final int? id;
  final int projectId;
  final String? title;
...
/// For backward compatibility, BookingV2 is an alias for Booking
/// New code should use Booking directly
