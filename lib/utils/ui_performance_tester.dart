...
class UIPerformanceTester {
  ...
  Future<String> runAllTests(BuildContext context) async {
    ...
    await _testNavigationPerformance(context);
    await _testScrollingPerformance(context);
    await _testAnimationPerformance(context);
  ...
  Future<void> _testNavigationPerformance(BuildContext context) async {
  ...
  Future<void> _testScrollingPerformance(BuildContext context) async {
    ...
    for (final screen in scrollableScreens) {
      ...
      await _simulateScrolling(context);
  ...
  Future<void> _testAnimationPerformance(BuildContext context) async {
    ...
    for (final screen in animationScreens) {
      ...
      await _simulateAnimations(context, screen);
  ...
  Future<void> _simulateScrolling(BuildContext context) async {
  ...
  Future<void> _simulateAnimations(BuildContext context, String screen) async {
    // This is a simplified simulation
