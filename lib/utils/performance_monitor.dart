...
class PerformanceMonitor {
  ...
  void _captureMemoryUsage() {
    // This is a simplified approach - in a real app, you'd use platform-specific
    // methods to get more accurate memory usage
    final memoryInfo = developer.getMemoryInfo();
    final heapUsage = memoryInfo.heapUsage;
    _memoryUsage.add(heapUsage);
    
    LogService.debug('Memory usage: ${(heapUsage / 1024 / 1024).toStringAsFixed(2)} MB');
  }
